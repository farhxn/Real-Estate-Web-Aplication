                ...
                <div class="flex flex-wrap items-center justify-between">
                    ...
                    <div class="w-full hidden lg:block lg:w-auto mt-5 lg:mt-0">
                        <div class="relative mt-10 md:mt-0 lg:absolute lg:right-0 lg:bottom-0">
                            <img class="hero_image lg:max-w-[550px] xl:max-w-[650px] 2xl:max-w-[714px]" src="{{asset('assets/images/newsletter/bg-1.png')}}" width="866" height="879" alt="hero image">
                        </div>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-12 gap-x-[30px] mb-[-30px]">
            <div class="col-span-12 sm:col-span-6 lg:col-span-4 mb-[30px]">
                <a href="{{url('/')}}" class="block mb-[25px]">
                    <img src="{{asset('assets/images/logo/logo.svg')}}" width="99" height="46" loading=lazy alt="footer logo">
                </a>
                ...
                <p class="text-sm hidden md:block">&copy; <a href="https://farhanatif.netlify.app" target="_blank" class="text-secondary">M. Farhan Atif.</a> All Rights Reserved - Privacy Policy</p>
            </div>
            ...
            <div class="col-span-12 sm:col-span-6 lg:col-span-2 mb-[30px]">
                ...
                <p>House #123 Shamsi Society
                    Karachi, PK</p>
                <ul class="inline-flex items-center justify-center mt-[20px]">
                    <li class="first:ml-0 ml-[15px]">
                        <a href="https://www.facebook.com/farhan.atif.5036/" aria-label="svg" class="w-[22px] h-[22px] transition-all rounded-full bg-primary flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary">
                    ...
                    <li class="ml-[15px]">
                        <a href="https://www.instagram.com/farhan._18._/" aria-label="svg" class="w-[22px] h-[22px] transition-all rounded-full bg-primary flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary">
                ...
                <p class="text-sm md:hidden mb-7 sm:mb-0 mt-[20px]">&copy; <a href="https://farhanatif.netlify.app" target="_blank" class="text-secondary">M. Farhan Atif.</a> All Rights Reserved - Privacy Policy</p>
            </div>
        </div>
    </div>
</footer>
