        ...
        <div class="grid grid-cols-12">
            <div class="col-span-12">
                <div class="max-w-[700px]  mx-auto text-center text-white relative z-[1]">
                    <div class="mb-5"><span class="text-base block">Agency Detail</span></div>
                    <h1 class="font-lora text-[32px] sm:text-[50px] md:text-[68px] lg:text-[50px] leading-tight xl:text-2xl font-medium">{{ $agency->title }} Details</h1>
    ...
    <div class="container">
        <div class="grid sm:grid-cols-12">
            <div class="col-span-12 md:col-span-4 lg:col-span-3">
                <ul class="flex flex-wrap lg:flex-col list-none items-center border-[1px] border-secondary rounded-[8px] h-full text-center px-10 py-[30px] md:py-[50] lg:py-[55px] xl:py-[60px] xl:max-w-[230px] xl:mr-0 md:mr-[20px] ">
                    <li class="w-full border-b-[1px] border-[#1B2D40]/60 pb-3 mb-3 md:pb-3 md:mb-3 lg:pb-6 xl:pb-10 lg:mb-6 xl:mb-10">
                        <span class="font-lora text-secondary text-lg"><span class="counter-up">{{ $PropertyCounts[$agency->id] ?? 0 }}</span>
                            <span>+</span></span>
                        <p>Properties</p>
                    </li>
                    <li class="w-full border-b-[1px] border-[#1B2D40]/60 pb-3 mb-3 md:pb-3 md:mb-3 lg:pb-6 xl:pb-10 lg:mb-6 xl:mb-10">
                        <span class="font-lora text-secondary text-lg"><span class="counter-up">{{ $AgentCounts[$agency->id] ?? 0 }}</span>
                            <span>+</span></span>
                        <p>Agents</p>
                    </li>
            ...
            <div class="col-span-12 md:col-span-8 lg:col-span-9 mt-10 md:mt-0">
                <div class="p-[30px] rounded-[10px] drop-shadow-[0px_2px_15px_rgba(0,0,0,0.1)] bg-[#FFFDFC]">
                    <!-- <img class="self-center mb-[15px] w-full h-full" src="{{ asset('Agency/'.$agency->img) }}" alt="brand logo"> -->
                    <img class="self-center xl:mb-0 w-full" src="{{ asset('Agency/'.$agency->img) }}" alt="brand logo" style="height: 400px; object-fit: contain;">
        ...
        <div class="grid grid-cols-2 gap-7 mt-20">
            <div class="max-w-[530px]">
                <h4 class="font-lora text-primary text-[24px] lg:text-[36px] mb-[10px]">Overview<span class="text-secondary">.</span></h4>
                <p class="mb-12">{{ $agency->desc }}.</p>
                <ul class="font-lora text-[18px] flex flex-wrap sm:items-center justify-between m-[-10px] flex-col sm:flex-row items-start">
                    <li class="m-[10px]">
                        <span class="text-secondary block">Phone no.</span>
                        <a href="tel:+9985254784" class="text-primary">{{ $agency->phone }}</a>
                    </li>
                    <li class="m-[10px]">
                        <span class="text-secondary block">Agent.</span>
                        <span class="text-primary"> {{ $AgentCounts[$agency->id] ?? 0 }} Agent</span>
                    </li>
                    <li class="m-[10px]">
                        <span class="text-secondary block">Properties.</span>
                        <span class="text-primary">{{ $PropertyCounts[$agency->id] ?? 0 }} Properties</span>
                    </li>
                </ul>
            </div>
            <div class="">
                <h4 class="font-lora text-primary text-[24px] lg:text-[36px] mb-[10px]">Address<span class="text-secondary">.</span></h4>
                <span class="underline font-light block text-[18px] mb-[15px]"><a href="https://www.google.com/maps/search/?api=1&query={{ urlencode($agency->name) }}" target="_blank">{{ $agency->name }}</a></span>
...
<section class="featured-properties pb-[80px] lg:pb-[120px]">
    <div class="container">
        <div class="grid grid-cols-12">
            <div class="col-span-12">
            ...
            <div class="col-span-12 flex flex-wrap flex-col md:flex-row items-start justify-between mb-[50px]">
                ...
                <ul class="all-properties flex flex-wrap lg:pt-[10px]">
                    ...
                    <li data-tab="ForBuy" class="mr-[30px] md:mr-[45px] mb-4 lg:mb-0 leading-none"><button class="leading-none capitalize text-primary hover:text-secondary transition-all text-[16px] ease-out">For Buy</button></li>
                    <li data-tab="ForSale" class="mr-[30px] md:mr-[45px] mb-4 lg:mb-0 leading-none"><button class="leading-none capitalize text-primary hover:text-secondary transition-all text-[16px] ease-out">For Rent</button></li>
                    <li data-tab="ForRent" class="mr-[30px] md:mr-[45px] mb-4 lg:mb-0 leading-none"><button class="leading-none capitalize text-primary hover:text-secondary transition-all text-[16px] ease-out">For Sale</button></li>
                    <li data-tab="co-living2" class="md:mr-[0px] mb-4 lg:mb-0 leading-none"><button class="leading-none capitalize text-primary hover:text-secondary transition-all text-[16px] ease-out">For Co-Living</button>
                    </li>
                </ul>
            </div>
            <div class="col-span-12">
