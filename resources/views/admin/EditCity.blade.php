    ...
    <div class="container-fluid">
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit {{ $City->Name }} Detail</a></li>
            </ol>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    @if ($errors->any())
                        ...
                        @endif
                    <form method="post" action="{{url('UpdateCity',$City->id)}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="mb-3 col">
                                    <label class="form-label">City Name</label>
                                    <input type="text" name="name" class="form-control" value="{{$City->Name}}" placeholder="Karachi..." required="">
                                </div>

                                <div class="mb-3 col">
                                    <label for="fileUpload" class="form-label small-label">Upload Image:</label>
                                    <input type="file" name="img" class="form-control form-control-sm" id="fileUpload" accept=".jpeg, .jpg, .png" />
                                </div>
                                <div class="mb-3 col">
                                    <img id="previewImage" src="{{ asset('City/'. $City?->Image) }}" alt="Image Preview" style="max-width: 100%; height: auto;" />
